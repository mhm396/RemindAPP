...
//import com.example.mifirestore01.Notas1.NoteAdapter;
//import com.example.mifirestore01.Notas1.UpdateNoteActivity;
...
public class NoteAdapter2 extends RecyclerView.Adapter<NoteAdapter2.NoteHolder>{
    ...
    private NoteAdapter2.OnItemClickListener listener;

    private Context contexto;
    List<Note> notas;

    public NoteAdapter2(Context context, List<Note> notas){
    ...
    public NoteAdapter2.NoteHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View vista = LayoutInflater.from(parent.getContext()).inflate(R.layout.note_item2, parent,false);
        NoteAdapter2.NoteHolder holder2 = new NoteAdapter2.NoteHolder(vista);
        return holder2;
    }


    @Override
    public void onBindViewHolder(@NonNull final NoteAdapter2.NoteHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(contexto, UpdateNote2Activity.class);
...
//            });
    ...
    public void setOnItemClickListener(NoteAdapter2.OnItemClickListener listener){
